...
import link.alpinia.Jasper.model.ServerManager;
import link.alpinia.Jasper.util.EmbedUI;
import link.alpinia.Jasper.util.LoggingManager;
import link.alpinia.Jasper.listener.MainListener;
import link.alpinia.Jasper.listener.SkynetListener;
...
public class Jasper {
    ...
    public void start() {
        ...
        activeCommands = registrar.getCommandClasses("link.alpinia.Jasper.command");
